    ...
    BootstrapTable.prototype.initSearch = function () {
        ...
        if (this.options.sidePagination !== 'server') {
            ...
            this.data = s ? $.grep(this.data, function (item, i) {
            	for(var i = 0; i < that.header.searchables.length; i++) {
            		if (that.header.searchables[i]) {
            			var f = that.header.fields[i].split(".");
            			var value = "";
            			if (f.length == 1) {
            				value = item[f[0]];
            			} else if (f.length == 2) {
            				...
            				value = item[f[0]][f[1]][f[3]];
            			} else {
            				console.log("only support three layer!");
            			}
